...
public class Controller {
    ...
    public void rank() {
        if ((score / 2) > 10 && (score / 2) <= 20) {
            f.lbrank.setText("Rank: Bronze");
        } else if ((score / 2) <= 30 && (score / 2) > 20) {
            f.lbrank.setText("Rank: Silver");
        } else if ((score / 2) <= 40 && (score / 2) > 30) {
            f.lbrank.setText("Rank: Gold");
        } else if ((score / 2) > 40) {
            f.lbrank.setText("Rank: Platinum");
        }
